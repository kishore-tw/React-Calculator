...
return (
    ...
    <Grid item>
    <span className="button"><Button  id="plus" onClick = {data => onClickChange("+")}
     variant="contained" color="default"> + </Button></span>

    <span className="button"><Button  id="minus" onClick = {data => onClickChange("-")} 
    variant="contained" color="default"> - </Button></span>

    <span className="button"><Button  id="multiply" onClick = {data => onClickChange("*")} 
    variant="contained" color="default"> * </Button></span>
    
    <span className="button"><Button  id="divide" onClick = {data => onClickChange("/")} 
    variant="contained" color="default"> / </Button></span>
    </Grid>
